...
<head>
    ...
    <!-- /font files -->
    <!-- css files -->
    <link href="{{asset('public/Fontend/css/404.css')}}" rel="stylesheet" type="text/css" media="all" />
    <!-- /css files -->
    <!-- js files -->
...
<div class="container demo-2">
    <div class="content">
        <div id="large-header" class="large-header">
            ...
            <img src="{{asset('public/Fontend/images/owl.gif')}}" alt="flashy" class="w3l">
            <h2 class="main-title">404</span></h2>
            <p class="w3-agileits2"><a style="text-align: center;color: white" href="{{url('/shop')}}">Back to home</a></p>
...
<!-- js files -->
<script src="{{asset('public/Fontend/js/rAF.js')}}"></script>
<script src="{{asset('public/Fontend/js/demo-2.js')}}"></script>
