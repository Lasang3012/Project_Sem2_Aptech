...
<div class="log-w3">
    <div class="w3layouts-main">
        ...
        @endif
        <form action="{{URL::to('/recover-password-admin')}}" method="post">
            @csrf

            <input type="email" class="ggg" name="email_forget" placeholder="Điền email" >
{{--            <input type="password" class="ggg" name="forget_password" placeholder="Điền password" >--}}
